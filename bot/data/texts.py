...
_buttons = {
    ...
    "admin_admins": "Admin",
    "admin_telegramapp": "📱 Telegram app",
    "admin_telegramapp_extra": "📱 Telegram Extra app",
    "admin_userbot": "🤖 User botlar",
    "admin_userbot_extra": "🤖 Extra User botlar",
    "admin_link_statestika": "📈 Link stat",
    "admin_kuzatuvidagi_botlar": "👀 Kuzatuvdagi botlar",
    "admin_dbbots": "📦 DB botlar",
    "admin_media_channel": "🔸Kanallar(user bot)",
    ...
    "user_default_clinic": "🏥Klinikalar",
    "user_default_sozlamalar": "⚙️Sozlamalar",
