...
from .admin_telegramapp_extra import router as admin_telegramapp_extra_router
...
from .admin_userbot_extra import router as admin_userbot_extra_router
...
routers = [admin_base_router, admin_users_router,
           ...
           admin_userbot_extra_router, admin_telegramapp_extra_router]
